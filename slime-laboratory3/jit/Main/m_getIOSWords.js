...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_getIOSWords(local1 /* String */, local2 /* int */) {
...
//        stack1 = ",";// JIT: redundant assigment, value unused
        ...
        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
            ...
            _e || console.warn('[m_getIOSWords] Coerce Type not found:', "Array")
...
//# sourceURL=http://jit/Main/m_getIOSWords.js
})