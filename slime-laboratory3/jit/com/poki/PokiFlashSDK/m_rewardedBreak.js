...
/*
	Index: 3121
	Path:  com/poki/PokiFlashSDK::m_rewardedBreak
	Type:  Public
	Kind:  Method
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_rewardedBreak() {
...
//                        stack1 = "rewardedBreak()";// JIT: redundant assigment, value unused
                        /* We sure that this safe call, represented in TRAIT as Method  */ 
                        this.$BgconsoleLog("rewardedBreak()");
//                        stack0 = this;// JIT: redundant assigment, value unused
                        // 7 3::adBlocked
...
//                        stack2 = "window.rewardedBreak();";// JIT: redundant assigment, value unused
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            stack0.call("eval", "window.rewardedBreak();");
                        } else {
                            // 7 0::call
                            {
                                let t = stack0;
                                ...
                                if( typeof m === "function" ) { 
                                    m.call(t, "eval", "window.rewardedBreak();");
                                } else { 
                                   stack0.axCallProperty($names[2], ["eval", "window.rewardedBreak();"], false);
                                }
                            }
                        }
                        return;
...
//# sourceURL=http://jit/com/poki/PokiFlashSDK/m_rewardedBreak.js
})