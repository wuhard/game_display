...
/*
	Index: 3117
	Path:  com/poki/PokiFlashSDK::m_gameInteractive
	Type:  Public
	Kind:  Method
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_gameInteractive() {
...
//                        stack1 = "gameInteractive()";// JIT: redundant assigment, value unused
                        /* We sure that this safe call, represented in TRAIT as Method  */ 
                        this.$BgconsoleLog("gameInteractive()");
//                        stack0 = this;// JIT: redundant assigment, value unused
                        // 7 3::initialized
...
//                        stack2 = "PokiSDK.gameInteractive();";// JIT: redundant assigment, value unused
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            stack0.call("eval", "PokiSDK.gameInteractive();");
                        } else {
                            // 7 0::call
                            {
                                let t = stack0;
                                ...
                                if( typeof m === "function" ) { 
                                    m.call(t, "eval", "PokiSDK.gameInteractive();");
                                } else { 
                                   stack0.axCallProperty($names[1], ["eval", "PokiSDK.gameInteractive();"], false);
                                }
                            }
                        }
                        return;
...
//# sourceURL=http://jit/com/poki/PokiFlashSDK/m_gameInteractive.js
})