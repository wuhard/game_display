...
/*
	Index: 598
	Path:  interfaces/VirtualDPad::m_downTapHandler
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_downTapHandler(local1 /* TouchEvent */) {
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            {
                                let t = stack0;
                                const m = t.$BgdownKeyDown || (t = sec.box(stack0), t.$BgdownKeyDown);
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            {
                                let t = stack0;
                                const m = t.$BgdownKeyUp || (t = sec.box(stack0), t.$BgdownKeyUp);
                                if( typeof m === "function" ) { 
                                    m.call(t);
                                } else { 
...
//# sourceURL=http://jit/interfaces/VirtualDPad/m_downTapHandler.js
})