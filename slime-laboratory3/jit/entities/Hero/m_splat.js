                           ...
                           stack1 = stack1.GetSlimeParticleIndex();
                            ...
                            // 7 0::GetSlimeParticleIndex
                            {
                                ...
                                if( typeof m === "function" ) { 
                                    ...
                                    stack1 = stack1.axCallProperty($names[17], [], false);
                                }
                            }
                        }
                        if (!(_a = typeof local2, ((_a !== 'object' && _a !== 'function' ) || local2 == null || local2[AX_CLASS_SYMBOL]))) {
                            local2.gotoAndStop(stack1);
                        } else {
                            // 7 0::gotoAndStop
                            {
                                let t = local2;
                                const m = t.$BggotoAndStop || (t = sec.box(local2), t.$BggotoAndStop);
                                if( typeof m === "function" ) { 
                                    m.call(t, stack1);
                                } else { 
                                   local2.axCallProperty($names[18], [stack1], false);
                                }
                            }
                        }
                        local1 = (local1 | 0) + 1;
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            // 7 0::PlaySound
                            {
                                ...
                                if( typeof m === "function" ) { 
                                   ...
                                   stack0.axCallProperty($names[20], ["decrease"], false);
                                }
                            }
                        }
                        // 7 0::Utils
...
//                        stack1 = 1;// JIT: redundant assigment, value unused
                        ...
                        if (!(stack0 != undefined && stack0[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[21], 1, stack0);
                        }
//                        stack0 = this;// JIT: redundant assigment, value unused
//                        stack1 = 1;// JIT: redundant assigment, value unused
                        // 7 0::magnitude
...
//# sourceURL=http://jit/entities/Hero/m_splat.js
})