...
/*
	Index: 1154
	Path:  entities/Hero::m_getBitmapFilter
	Type:  Private
	Kind:  Method
...
//        stack0 = this;// JIT: redundant assigment, value unused
        ...
        stack0 = this.$BggetSlimeShadowColor();
        stack0 = +stack0;
        local1 = stack0;
        stack0 = 225;
        stack0 = +225;
...
//        stack10 = local9;// JIT: redundant assigment, value unused
        stack0 = context.constructprop($names[2], stack0, [local6, local2, local1, local3, local4, local5, local7, local10, local8, local9]);
        return stack0;
    }
//# sourceURL=http://jit/entities/Hero/m_getBitmapFilter.js
})