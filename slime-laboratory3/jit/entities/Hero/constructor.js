...
/*
	Index: 1110
	Path:  entities/Hero::constructor
	Type:  Public
	Kind:  null
...
//                        stack5 = 0;// JIT: redundant assigment, value unused
                        ...
                        stack4 = local5;
                        local5 = stack4;
                        // 7 1:entities:Hero::t_time
                        /* We sure that this safe set, represented in TRAIT as Slot, with type: 7 0::Number  */ 
                        this.$Bgt_time = (+stack3);
                        stack2 = local5;
                        //IR: KILL removed, reason: prevent optimisation
                        stack3 = local5;
                        local5 = stack3;
                        // 7 1:entities:Hero::t_diff
                        /* We sure that this safe set, represented in TRAIT as Slot, with type: 7 0::Number  */ 
                        this.$Bgt_diff = (+stack2);
//                        stack1 = local5;// JIT: redundant assigment, value unused
                        //IR: KILL removed, reason: prevent optimisation
                        // 7 1:entities:Hero::t_start
                        /* We sure that this safe set, represented in TRAIT as Slot, with type: 7 0::Number  */ 
                        this.$Bgt_start = (+local5);
//                        stack0 = this;// JIT: redundant assigment, value unused
//                        stack1 = 6;// JIT: redundant assigment, value unused
                        ...
                        this.$BgmaxYVel = 6;
//                        stack0 = this;// JIT: redundant assigment, value unused
//                        stack1 = 3.5;// JIT: redundant assigment, value unused
                        // 7 0::maxXVel
                        /* We sure that this safe set, represented in TRAIT as Slot, with type: 7 0::Number  */ 
                        this.$BgmaxXVel = 3.5;
//                        stack0 = this;// JIT: redundant assigment, value unused
...
//                        stack1 = false;// JIT: redundant assigment, value unused
                        ...
                        if (!(stack0 != undefined && stack0[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[19], false, stack0);
                        }
                        { p = 398; continue; };
                    case 376:
//                        stack0 = this;// JIT: redundant assigment, value unused
...
//                        stack1 = this;// JIT: redundant assigment, value unused
                        // 7 0::eye_frost1
                        //Possible type:7 0::EyeFrostSprite
                        /* We sure that this safe get, represented in TRAIT as Slot, type: 7 0:flash.display::MovieClip  */ 
...
//                        stack1 = false;// JIT: redundant assigment, value unused
                        ...
                        if (!(stack3 != undefined && stack3[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack3 === undefined || typeof stack3 === 'function') {
                                stack3 = temp.axGetProperty($names[24]);
                            }
                        }
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            // 7 0::setRule
                            {
                                ...
                                if( typeof m === "function" ) { 
                                   ...
                                   stack0.axCallProperty($names[25], [stack1, stack2, stack3], false);
                                }
                            }
                        }
                        /* GETLEX We sure that this safe get, represented in TRAIT as Slot  */ 
                        ...
                        if (!(stack3 != undefined && stack3[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack3 === undefined || typeof stack3 === 'function') {
                                stack3 = temp.axGetProperty($names[30]);
                            }
                        }
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            stack0.setRule(stack1, stack2, stack3);
                        ...
                        if (!(stack2 != undefined && stack2[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack2 === undefined || typeof stack2 === 'function') {
                                stack2 = temp.axGetProperty($names[31]);
                            }
                        }
                        // 7 0:entities::AnimationManager
                        temp = scope0.findScopeProperty($names[1], true, false);
                        ...
                        if (!(stack2 != undefined && stack2[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack2 === undefined || typeof stack2 === 'function') {
                                stack2 = temp.axGetProperty($names[36]);
                            }
                        }
                        // 7 0:entities::AnimationManager
                        temp = scope0.findScopeProperty($names[1], true, false);
                        ...
                        if (!(stack3 != undefined && stack3[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack3 === undefined || typeof stack3 === 'function') {
                                stack3 = temp.axGetProperty($names[37]);
                            }
                        }
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            stack0.setRule(stack1, stack2, stack3);
                        ...
                        if (!(stack2 != undefined && stack2[AX_CLASS_SYMBOL])) {
                            ...
                            if (stack2 === undefined || typeof stack2 === 'function') {
                                stack2 = temp.axGetProperty($names[38]);
                            }
                        }
                        // 7 0:entities::AnimationManager
                        temp = scope0.findScopeProperty($names[1], true, false);
                        ...
                        if (!(stack0 != undefined && stack0[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[39], stack1, stack0);
                        }
//                        stack0 = this;// JIT: redundant assigment, value unused
                        /* We sure that this safe call, represented in TRAIT as Method  */ 
...
//                        stack4 = 9;// JIT: redundant assigment, value unused
                        ...
                        stack1 = context.constructFast(stack1, [8, 8, 9], $names[41]);
                        // 7 0::collisionCircle
                        if (!(stack0 != undefined && stack0[AX_CLASS_SYMBOL])){
...
//# sourceURL=http://jit/entities/Hero/constructor.js
})