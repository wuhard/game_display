...
/*
	Index: 1090
	Path:  entities/SmallHero::m_updateAABB
	Type:  Public
	Kind:  Method
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        // 27 {3, 0, 0:entities, 1:entities:SmallHero, 0:flash.display, 0:flash.filters, 0:http://adobe.com/AS3/2006/builtin, 0:levels, 0:Box2D.Common.Math, 0:Box2D.Dynamics, 3, 2:entities, 0:flash.geom, 0:entities.particles, 0:Box2D.Collision, 0:Box2D.Collision.Shapes, 0:Box2D.Dynamics.Joints, 0:Box2D.Dynamics.Contacts, 5:entities:SmallHero, 5:entities:Entity}::*
                        {
                            ...
                            if (typeof simple === "number") {
                                ...
                                stack0 = b_obj['$Bg' + simple];
                                if (stack0 === undefined || typeof stack0 === 'function') {
                                    const rm = context.runtimename($names[0], local7);
                                    stack0 = b_obj.axGetProperty(rm);
                                }
                            }
                        }
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        stack0 = local5;
                        stack1 = local1;
                        if (!(local1 > local5)) { p = 144; continue; };
                        stack0 = local5;
                        stack0 = +local5;
                        local1 = stack0;
                        { p = 155; continue; };
                    case 144:
                        stack0 = local5;
                        stack1 = local3;
                        if (!(local3 < local5)) { p = 155; continue; };
                        stack0 = local5;
                        stack0 = +local5;
                        local3 = stack0;
                    case 155:
                        stack0 = local6;
                        stack1 = local2;
                        if (!(local2 > local6)) { p = 170; continue; };
                        stack0 = local6;
                        stack0 = +local6;
                        local2 = stack0;
                        { p = 183; continue; };
                    case 170:
                        stack0 = local6;
                        stack1 = local4;
                        if (!(local4 < local6)) { p = 183; continue; };
                        stack0 = local6;
                        stack0 = +local6;
                        local4 = stack0;
                    case 183:
...
//                        stack1 = this;// JIT: redundant assigment, value unused
                        ...
                        if (stack1 > local7) { p = 90; continue; };
                        stack0 = local1;
                        // 7 0::Utils
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            // 7 0::Set
                            {
                                ...
                                if( typeof m === "function" ) { 
                                   ...
                                   stack0.axCallProperty($names[17], [local8], false);
                                }
                            }
                        }
                        return;
...
//# sourceURL=http://jit/entities/SmallHero/m_updateAABB.js
})