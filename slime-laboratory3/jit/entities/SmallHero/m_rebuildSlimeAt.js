...
/*
	Index: 1085
	Path:  entities/SmallHero::m_rebuildSlimeAt
	Type:  Public
	Kind:  Method
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    ...
    return function compiled_m_rebuildSlimeAt(local1 /* b2Vec2 */) {
...
//                        stack4 = 7;// JIT: redundant assigment, value unused
                        ...
                        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
                            ...
                            _e || console.warn('[m_rebuildSlimeAt] Coerce Type not found:', "b2Vec2")
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        // 27 {3, 0, 0:entities, 1:entities:SmallHero, 0:flash.display, 0:flash.filters, 0:http://adobe.com/AS3/2006/builtin, 0:levels, 0:Box2D.Common.Math, 0:Box2D.Dynamics, 3, 2:entities, 0:flash.geom, 0:entities.particles, 0:Box2D.Collision, 0:Box2D.Collision.Shapes, 0:Box2D.Dynamics.Joints, 0:Box2D.Dynamics.Contacts, 5:entities:SmallHero, 5:entities:Entity}::*
                        {
                            ...
                            if (typeof simple === "number") {
                                ...
                                if (stack0 === undefined || typeof stack0 === 'function') {
                                    const rm = context.runtimename($names[11], local7);
...
//                        stack3 = local6;// JIT: redundant assigment, value unused
                        //JIT: Support fast construct:b2Vec2/Object
                        stack1 = context.constructFast(stack1, [local5, local6], $names[0]);
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            stack0.SetPosition(stack1);
                        } else {
...
//                        stack1 = this;// JIT: redundant assigment, value unused
                        ...
                        if (stack1 > local7) { p = 123; continue; };
                        return;
                    }
                }
            }
//# sourceURL=http://jit/entities/SmallHero/m_rebuildSlimeAt.js
})