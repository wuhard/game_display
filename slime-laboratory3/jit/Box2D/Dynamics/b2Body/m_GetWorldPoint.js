...
/*
	Index: 343
	Path:  Box2D/Dynamics/b2Body::m_GetWorldPoint
	Type:  Public
	Kind:  Method
	Super: Object
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_GetWorldPoint(local1 /* b2Vec2 */) {
...
//        stack0 = this;// JIT: redundant assigment, value unused
        ...
        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
            ...
            _e || console.warn('[m_GetWorldPoint] Coerce Type not found:', "b2Mat22")
...
//# sourceURL=http://jit/Box2D/Dynamics/b2Body/m_GetWorldPoint.js
})