...
/*
	Index: 344
	Path:  Box2D/Dynamics/b2Body::m_GetWorldVector
	Type:  Public
	Kind:  Method
	Super: Object
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_GetWorldVector(local1 /* b2Vec2 */) {
...
//        // JIT: potential type:7 0:Box2D.Common.Math::b2Vec2// JIT: redundant assigment, value unused
        ...
        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
           stack0 = stack0.MulMV(stack1, local1);
        } else {
            // 7 0::MulMV
            {
                let t = stack0;
                const m = t.$BgMulMV || (t = sec.box(stack0), t.$BgMulMV);
                if( typeof m === "function" ) { 
                    stack0 = t.$BgMulMV (stack1, local1);
                } else { 
...
//# sourceURL=http://jit/Box2D/Dynamics/b2Body/m_GetWorldVector.js
})