...
/*
	Index: 573
	Path:  Box2D/Common/Math/b2Math.MinV
	Type:  Public
	Kind:  Method
	Super: -
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_MinV(local1 /* b2Vec2 */, local2 /* b2Vec2 */) {
...
//        // JIT: potential type:7 0:Box2D.Common.Math::b2Vec2// JIT: redundant assigment, value unused
        ...
        stack1 = this.$BgMin(stack2, stack3);
        // 7 0::Min
        /* We sure that this scope owner, represented in TRAIT as Method  */ 
...
//        // JIT: potential type:7 0:Box2D.Common.Math::b2Vec2// JIT: redundant assigment, value unused
        ...
        /* We sure that this safe call, represented in TRAIT as Method  */ 
        stack2 = this.$BgMin(stack3, stack4);
...
//# sourceURL=http://jit/Box2D/Common/Math/b2Math/MinV.js
})