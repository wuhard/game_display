...
/*
	Index: 566
	Path:  Box2D/Common/Math/b2Math.AddMM
	Type:  Public
	Kind:  Method
	Super: -
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_AddMM(local1 /* b2Mat22 */, local2 /* b2Mat22 */) {
...
//        // JIT: potential type:7 0:Box2D.Common.Math::b2Mat22// JIT: redundant assigment, value unused
        ...
        stack1 = this.$BgAddVV(stack2, stack3);
        // 7 0::AddVV
        /* We sure that this scope owner, represented in TRAIT as Method  */ 
...
//        // JIT: potential type:7 0:Box2D.Common.Math::b2Mat22// JIT: redundant assigment, value unused
        ...
        /* We sure that this safe call, represented in TRAIT as Method  */ 
        stack2 = this.$BgAddVV(stack3, stack4);
        ...
        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
            ...
            _e || console.warn('[AddMM] Coerce Type not found:', "b2Mat22")
...
//# sourceURL=http://jit/Box2D/Common/Math/b2Math/AddMM.js
})