...
/*
	Index: 2718
	Path:  SquaresPanelTopDownIn::m_frame1
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
             ...
             /* e */
             const flash_utils__Timer_def = context.getTopLevel(5); // flash.utils:Timer
...
//                        stack1 = local2;// JIT: redundant assigment, value unused
                        ...
                        if (!(local1 != undefined && local1[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[4], local2, local1);
                        }
...
//                        stack3 = 12;// JIT: redundant assigment, value unused
                        //JIT: Support fast construct:Timer/EventDispatcher
                        stack1 = context.constructFast(flash_utils__Timer_def, [40, 12], $names[5]);
                        // 7 0::timer
...
//# sourceURL=http://jit/SquaresPanelTopDownIn/m_frame1.js
})