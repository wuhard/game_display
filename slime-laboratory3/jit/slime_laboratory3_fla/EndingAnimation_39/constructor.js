...
/*
	Index: 2996
	Path:  slime_laboratory3_fla/EndingAnimation_39::constructor
	Type:  Public
	Kind:  null
...
//        stack1 = 179;// JIT: redundant assigment, value unused
//        stack2 = this;// JIT: redundant assigment, value unused
        // 7 2:slime_laboratory3_fla::frame180
        /* We sure that this safe get, represented in TRAIT as Method, type: undefined  */ 
        stack2 = this.axGetProperty($names[0]);
        /* We sure that this safe call, represented in TRAIT as Method  */ 
        this.$BgaddFrameScript(179, stack2);
        return;
    }
//# sourceURL=http://jit/slime_laboratory3_fla/EndingAnimation_39/constructor.js
})