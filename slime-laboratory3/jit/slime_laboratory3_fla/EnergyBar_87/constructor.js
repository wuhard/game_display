...
/*
	Index: 3001
	Path:  slime_laboratory3_fla/EnergyBar_87::constructor
	Type:  Public
	Kind:  null
...
//        stack2 = this;// JIT: redundant assigment, value unused
        // 7 2:slime_laboratory3_fla::frame30
        /* We sure that this safe get, represented in TRAIT as Method, type: undefined  */ 
        stack2 = this.axGetProperty($names[0]);
//        stack3 = 89;// JIT: redundant assigment, value unused
//        stack4 = this;// JIT: redundant assigment, value unused
        // 7 2:slime_laboratory3_fla::frame90
        /* We sure that this safe get, represented in TRAIT as Method, type: undefined  */ 
        stack4 = this.axGetProperty($names[1]);
        /* We sure that this safe call, represented in TRAIT as Method  */ 
        this.$BgaddFrameScript(29, stack2, 89, stack4);
        return;
    }
//# sourceURL=http://jit/slime_laboratory3_fla/EnergyBar_87/constructor.js
})