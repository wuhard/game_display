...
/*
	Index: 2973
	Path:  slime_laboratory3_fla/BlackFireDragonFireAnim_156::constructor
	Type:  Public
	Kind:  null
...
//        stack1 = 51;// JIT: redundant assigment, value unused
//        stack2 = this;// JIT: redundant assigment, value unused
        // 7 2:slime_laboratory3_fla::frame52
        /* We sure that this safe get, represented in TRAIT as Method, type: undefined  */ 
        stack2 = this.axGetProperty($names[0]);
        /* We sure that this safe call, represented in TRAIT as Method  */ 
        this.$BgaddFrameScript(51, stack2);
        return;
    }
//# sourceURL=http://jit/slime_laboratory3_fla/BlackFireDragonFireAnim_156/constructor.js
})