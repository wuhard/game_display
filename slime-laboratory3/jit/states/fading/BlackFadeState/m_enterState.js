...
/*
	Index: 1063
	Path:  states/fading/BlackFadeState::m_enterState
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::void
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        if (!(stack1 != undefined && stack1[AX_CLASS_SYMBOL])) {
                            stack1 = stack1['__width'];
                        } else {
                            temp = stack1[AX_CLASS_SYMBOL] ? stack1 : sec.box(stack1);
                            stack1 = temp.$Bg__width;
                            if (stack1 === undefined || typeof stack1 === 'function') {
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        //Possible type:7 0::Utils
                        if (!(stack1 != undefined && stack1[AX_CLASS_SYMBOL])) {
                            stack1 = stack1['__height'];
                        } else {
                            temp = stack1[AX_CLASS_SYMBOL] ? stack1 : sec.box(stack1);
                            stack1 = temp.$Bg__height;
                            if (stack1 === undefined || typeof stack1 === 'function') {
...
//# sourceURL=http://jit/states/fading/BlackFadeState/m_enterState.js
})