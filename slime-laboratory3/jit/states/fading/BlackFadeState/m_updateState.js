...
/*
	Index: 1064
	Path:  states/fading/BlackFadeState::m_updateState
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::void
...
//                        stack2 = local3;// JIT: redundant assigment, value unused
                        ...
                        if (!(local2 != undefined && local2[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[5], local3, local2);
                        }
                        //IR: KILL removed, reason: prevent optimisation
                        //IR: KILL removed, reason: prevent optimisation
                        stack1 = 0;
                        if (!(0 <= stack0)) { p = 145; continue; };
//                        stack0 = this;// JIT: redundant assigment, value unused
...
//                        stack1 = local3;// JIT: redundant assigment, value unused
                        // 7 3::alphaCounter
                        if (!(local2 != undefined && local2[AX_CLASS_SYMBOL])){
                            local2.alphaCounter = local3;
                        } else {
                            context.setproperty($names[6], local3, local2);
                        }
                        //IR: KILL removed, reason: prevent optimisation
                        //IR: KILL removed, reason: prevent optimisation
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        stack0 = this.$BgalphaCounter;
                        stack1 = 2;
                        if (!(2 < stack0)) { p = 145; continue; };
//                        stack0 = this;// JIT: redundant assigment, value unused
//                        stack1 = 0;// JIT: redundant assigment, value unused
                        // 7 3::alphaCounter
                        /* We sure that this safe set, represented in TRAIT as Slot, with type: 7 0::int  */ 
                        this.$BgalphaCounter = 0;
//                        stack0 = this;// JIT: redundant assigment, value unused
                        // 7 3::fader
                        //Possible type:7 0::int
                        /* We sure that this safe get, represented in TRAIT as Slot, type: 7 0::BlackPanel  */ 
...
//                        stack1 = true;// JIT: redundant assigment, value unused
                        ...
                        if (!(local1 != undefined && local1[AX_CLASS_SYMBOL])){
                            ...
                            context.setproperty($names[8], true, local1);
                        }
//                        stack0 = this;// JIT: redundant assigment, value unused
//                        stack1 = 0;// JIT: redundant assigment, value unused
                        // 7 3::delayCounter
                        ...
                        if (!(_a = typeof local1, ((_a !== 'object' && _a !== 'function' ) || local1 == null || local1[AX_CLASS_SYMBOL]))) {
                            ...
                            // 7 0::removeFader
                            {
                                ...
                                if( typeof m === "function" ) { 
                                   ...
                                   local1.axCallProperty($names[9], [], false);
                                }
                            }
                        }
                    case 241:
...
//# sourceURL=http://jit/states/fading/BlackFadeState/m_updateState.js
})