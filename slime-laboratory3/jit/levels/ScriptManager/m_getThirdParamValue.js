...
/*
	Index: 643
	Path:  levels/ScriptManager::m_getThirdParamValue
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::int
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_getThirdParamValue(local1 /* String */) {
...
//        stack1 = "_";// JIT: redundant assigment, value unused
        ...
        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
            ...
            _e || console.warn('[m_getThirdParamValue] Coerce Type not found:', "Array")
...
//# sourceURL=http://jit/levels/ScriptManager/m_getThirdParamValue.js
})