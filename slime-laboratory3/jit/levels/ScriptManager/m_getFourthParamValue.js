...
/*
	Index: 644
	Path:  levels/ScriptManager::m_getFourthParamValue
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::int
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_getFourthParamValue(local1 /* String */) {
...
//        stack1 = "_";// JIT: redundant assigment, value unused
        ...
        if ((stack0 != undefined && stack0[AX_CLASS_SYMBOL])) {
            ...
            _e || console.warn('[m_getFourthParamValue] Coerce Type not found:', "Array")
...
//# sourceURL=http://jit/levels/ScriptManager/m_getFourthParamValue.js
})