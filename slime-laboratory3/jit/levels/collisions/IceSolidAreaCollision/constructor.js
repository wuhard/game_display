...
/*
	Index: 1704
	Path:  levels/collisions/IceSolidAreaCollision::constructor
	Type:  Public
	Kind:  null
...
//        stack1 = false;// JIT: redundant assigment, value unused
        ...
        stack0 = context.constructFast(stack0, [false], $names[18]);
        //IR: Drop coerce, reason: redundant
        stack1 = stack0;
        local10 = stack1;
        ...
        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
            ...
            // 7 0::SetUserData
            {
                ...
                if( typeof m === "function" ) { 
                   ...
                   stack0.axCallProperty($names[20], [local10], false);
                }
            }
        }
        return;
    }
//# sourceURL=http://jit/levels/collisions/IceSolidAreaCollision/constructor.js
})