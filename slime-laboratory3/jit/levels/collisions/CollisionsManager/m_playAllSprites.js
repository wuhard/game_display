...
/*
	Index: 617
	Path:  levels/collisions/CollisionsManager::m_playAllSprites
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::void
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            // 9 {3, 0, 0:levels.collisions, 1:levels.collisions:CollisionsManager, 3, 2:levels.collisions, 0:http://adobe.com/AS3/2006/builtin, 0:flash.display, 0:flash.geom, 0:entities, 0:levels, 5:levels.collisions:CollisionsManager}::playSprite
                            {
                                let t = stack0;
                                const m = t.$BgplaySprite || (t = sec.box(stack0), t.$BgplaySprite);
...
//# sourceURL=http://jit/levels/collisions/CollisionsManager/m_playAllSprites.js
})