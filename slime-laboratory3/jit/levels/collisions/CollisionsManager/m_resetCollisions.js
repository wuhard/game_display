...
/*
	Index: 615
	Path:  levels/collisions/CollisionsManager::m_resetCollisions
	Type:  Public
	Kind:  Method
	Super: Object
	Return: 7 0::void
...
const AX_CLASS_SYMBOL = context.AX_CLASS_SYMBOL;
    return function compiled_m_resetCollisions() {
...
//                        stack0 = this;// JIT: redundant assigment, value unused
                        ...
                        if (!(_a = typeof stack0, ((_a !== 'object' && _a !== 'function' ) || stack0 == null || stack0[AX_CLASS_SYMBOL]))) {
                            ...
                            // 9 {3, 0, 0:levels.collisions, 1:levels.collisions:CollisionsManager, 3, 2:levels.collisions, 0:http://adobe.com/AS3/2006/builtin, 0:flash.display, 0:flash.geom, 0:entities, 0:levels, 5:levels.collisions:CollisionsManager}::reset
                            {
                                let t = stack0;
                                const m = t.$Bgreset || (t = sec.box(stack0), t.$Bgreset);
...
//# sourceURL=http://jit/levels/collisions/CollisionsManager/m_resetCollisions.js
})